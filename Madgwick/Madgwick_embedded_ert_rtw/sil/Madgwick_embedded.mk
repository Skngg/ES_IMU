###########################################################################
## Makefile generated for Simulink model 'Madgwick_embedded'. 
## 
## Makefile     : Madgwick_embedded.mk
## Generated on : Mon Nov 23 21:39:10 2020
## MATLAB Coder version: 5.0 (R2020a)
## 
## Build Info:
## 
## Final product: ./Madgwick_embedded.exe
...
MODELREF_LINK_RSPFILE     = Madgwick_embedded_ref.rsp
COMPILER_COMMAND_FILE     = Madgwick_embedded_comp.rsp
CMD_FILE                  = Madgwick_embedded.rsp
...
DEFINES_CUSTOM = 
DEFINES_OPTS = -DTID01EQ=1 -DXIL_SIGNAL_HANDLER=1 -DCODER_ASSUMPTIONS_ENABLED=1 -DRTIOSTREAM_RX_BUFFER_BYTE_SIZE=50000 -DRTIOSTREAM_TX_BUFFER_BYTE_SIZE=50000 -DMEM_UNIT_BYTES=1 -DMemUnit_T=uint8_T
DEFINES_STANDARD = -DMODEL=Madgwick_embedded -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(MATLAB_ROOT)/toolbox/rtw/targets/pil/c/xil_interface_lib.c $(MATLAB_ROOT)/toolbox/rtw/targets/pil/c/xil_data_stream.c $(MATLAB_ROOT)/toolbox/rtw/targets/pil/c/xil_services.c $(START_DIR)/Madgwick_embedded_ert_rtw/sil/xil_interface.c $(MATLAB_ROOT)/toolbox/rtw/targets/pil/c/xilcomms_rtiostream.c $(MATLAB_ROOT)/toolbox/rtw/targets/pil/c/xil_rtiostream.c $(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils/rtiostream_utils.c $(MATLAB_ROOT)/toolbox/rtw/targets/pil/c/coder_assumptions_app.c $(MATLAB_ROOT)/toolbox/rtw/targets/pil/c/coder_assumptions_data_stream.c $(MATLAB_ROOT)/toolbox/rtw/targets/pil/c/coder_assumptions_rtiostream.c $(MATLAB_ROOT)/toolbox/rtw/targets/pil/c/sil_main.c $(MATLAB_ROOT)/toolbox/rtw/targets/pil/c/target_io.c $(MATLAB_ROOT)/toolbox/coder/rtiostream/src/rtiostreamtcpip/rtiostream_tcpip.c
...
MODELREF_LIBS = ../Madgwick_embedded.obj ../rtGetInf.obj ../rtGetNaN.obj ../rt_nonfinite.obj

LIBS = $(START_DIR)/Madgwick_embedded_ert_rtw/coderassumptions/lib/Madgwick_embedded_ca.lib
...
xil_interface.obj : $(START_DIR)/Madgwick_embedded_ert_rtw/sil/xil_interface.c
	$(CC) $(CFLAGS) -o "$@" "$<"
